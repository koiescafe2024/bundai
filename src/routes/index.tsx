...
import SubAgentPage from '@/pages/subagent';

import WrapperRouteComponent from './config';
import NewPlayerStatistics from '@/pages/new-player-statistics';
import PlayerStats from '@/pages/player-stats';
import WinLossReport from '@/pages/report/winloss';
import BetsHistory from '@/pages/history/bets';
import ProtectedRoute from './protectedRoute';
import MemberManagement from '@/pages/member/management';
import Employee from '@/pages/member/employee';
import Setting from '@/pages/setting';
import EditRolePage from '@/pages/member/edit-role';
...
const routeList: RouteObject[] = [
  ...
  {
    path: '/',
    element: <WrapperRouteComponent element={<ProtectedRoute element={<LayoutPage />} titleId='' /> } />,
    children: [
      {
        path: '',
      ...
      },
      {
        ...
        element: <WrapperRouteComponent element={<NewPlayerStatistics />} titleId="title.new-player-statistics" />,
      },
      {
        path: 'player-stats',
        element: <WrapperRouteComponent element={<PlayerStats />} titleId="title.player-stats" />,
      },
      {
        path: 'report/win-loss',
        element: <WrapperRouteComponent element={<WinLossReport />} titleId="title.winloss-reports" />,
      },
      {
        path: 'sub-agent/manage',
        element: <WrapperRouteComponent element={<SubAgentPage />} titleId="title.sub-agent.manage" />,
      },  
      {
        path: 'history/bets',
        element: <WrapperRouteComponent element={<BetsHistory />} titleId="title.history.bets" />,
      },  
      {
        path: 'member/management',
        element: <WrapperRouteComponent element={<MemberManagement /> } titleId='title.member.management' />,
      },
      {
        path: 'member/employee',
        element: <WrapperRouteComponent element={<Employee /> } titleId='title.member.employee' />,
      },
      {
        path: 'member/employee-edit-role/:admin_id',
        element: <WrapperRouteComponent element={<EditRolePage /> } titleId='title.member.employee' />,
      },
      {
        path: 'setting',
        element: <WrapperRouteComponent element={<Setting /> } titleId='title.member.employee' />,
      },
      {
        path: 'documentation',
